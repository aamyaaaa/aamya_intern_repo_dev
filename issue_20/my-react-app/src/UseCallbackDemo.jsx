...
function UseCallbackDemo() {
  ...
  return (
    <div
      className={`rounded-xl shadow-md p-6 mt-4 w-full max-w-md ${containerClasses}`}
    >
      ...
      <p className="text-xs text-slate-500">
        Try toggling the theme and watching the console. With useCallback +
        React.memo, <code>ChildButton</code> does not re-render when only the
        theme changes.
      </p>
    </div>
  );
